...
#endif
double dwTotal = 0;
double dwTotalFree = 0;
double dwTotalUsed = 0;
    do
    {
...
dwTotalFree+=atof(pTmp);
	 ...
	 insertKpidatachar(111, 1202, pTmp, szTime, szName);
        ...
        pclose(fp);
insertKpidataint(111, 1107, dwTotal, szTime, "disk");
insertKpidataint(111, 1108, dwTotalFree, szTime, "disk");
insertKpidataint(111, 1109, dwTotalUsed, szTime, "disk");

double dwUserdPer = 0;
if(dwTotal>0)
{
	dwUserdPer = dwTotalUsed/(dwTotal/100.0);
}
insertKpidataint(111, 1106, dwUserdPer, szTime, "disk");
